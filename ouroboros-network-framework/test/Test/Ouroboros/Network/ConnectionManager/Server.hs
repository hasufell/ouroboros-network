      ...
      $ \connectionManager ->
        withBidirectionalConnectionManager
          ...
          $ \_ serverAddr -> do
            ...
            case muxHandle of
                MuxRunning _ _ mux muxBundle _ -> do
                    ( resp0 :: Bundle [[resp]]) <-
        ...
        (\connectionManager0 _serverAddr0 ->
          withBidirectionalConnectionManager
            ...
            (\connectionManager1 _serverAddr1 -> do
              ...
              muxHandle0 <- includeOutboundConnection connectionManager0 localAddr1
              -- node 1 → node 0: reuse existing connection
              muxHandle1 <- includeOutboundConnection connectionManager1 localAddr0
              case (muxHandle0, muxHandle1) of
                  ( MuxRunning connId0 _version0 mux0 muxBundle0 _
                    , MuxRunning connId1 _version1 mux1 muxBundle1 _) -> do
