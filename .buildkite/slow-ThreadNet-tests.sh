...
#
# Typical test case run times, from
# https://buildkite.com/input-output-hk/ouroboros-network-nightly/builds/246#661523bd-3891-43c8-a769-745d523cfe79
#
#   o Cardano        2.9  seconds
#   o RealTPraos     6.2  seconds
#
# Typical test case run times, from
# https://buildkite.com/input-output-hk/ouroboros-network-nightly/builds/257#cf66bc9e-b08b-48e2-b975-5e70da841078
#
#   o ShelleyShelley 4.5 seconds
#
rows=(
    # From the slowest individual invocation ...
    '1 Cardano    Cardano        1500'  # ~50 minutes per
    '5 RealTPraos RealTPraos     100'   # ~10 minutes per
    '5 Cardano    ShelleyShelley 100'   # ~7  minutes per
