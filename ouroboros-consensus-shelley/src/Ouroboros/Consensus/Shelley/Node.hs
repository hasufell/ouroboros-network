...
shelleyBlockForging ::
     forall m era. (ShelleyConstraints era, IOLike m)
  => TPraosParams
...
protocolInfoShelley ::
     forall m c f. (IOLike m, ShelleyConstraints (ShelleyEra c), Foldable f)
...
instance ShelleyConstraints era => NodeInitStorage (ShelleyBlock era) where
...
instance ShelleyConstraints era => RunNode (ShelleyBlock era)
